...
@section('content')
    <div class="grid_12">
        ...
        <div class="blog">
            <div class="clear"></div>
            <img src="{{ asset('storage/' . $tour->img) }}" alt="" class="img_inner fleft mr10">
            ...
            <p class="imglist" style="max-width: 1000px;">
                @foreach($galleries as $gallery)
                    <a href="{{ asset('storage/' . $gallery->img) }}" data-fancybox="images">
                        <img src="{{ asset('storage/' . $gallery->resized_image) }}" alt="{{ $gallery->name }}" />
                    </a>
                @endforeach
            </p>
            <br>
