...
@section('content')
    @foreach($tours as $item)
        <div class="grid_4">
            <div class="banner">
                <img src="{{ asset('storage/' . $item->resized_image) }}" alt="{{ $item->title }}">
                <div class="label">
    ...
    <div class="grid_4 prefix_1">
        ...
        <form id="bookingForm" method="get" action="{{ route('tours.index') }}">
            ...
            <div class="tmRadio hot_tour">
                <label>
                    <input name="hot" value="1" type="checkbox" id="tmRadio0" data-constraints='	@RadioGroupChecked(name="Comfort", groups=[RadioGroup])' />
                    Горячий тур
                </label>
            </div>
            <div class="clear"></div>
