    ...
    <div class="card-body card-block">
        <form>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <select name="city_id" v-model="form.city_id"  id="selectLg" class="form-control-lg form-control">
                        <option  v-for="city in cities" :value="city.id" :selected="city.id === form.city_id">
                            {{ city.title }}
                        </option>
                    </select>
                </div>
